...
extends		AtomicModel
{
	...
	public static final String			URI = WindTurbineStateModel.class.
															getSimpleName();

	/** current state of the wind turbine.									*/
	protected State						currentState;
	/** last received event or null if none.								*/
	protected WindTurbineEventI				lastReceived;
		...
		) throws Exception
	{
		...
		assert	simParams.containsKey(
						SelfControlWindTurbineRTAtomicSimulatorPlugin.OWNER_REFERENCE_NAME);
		this.owner =
	...
	public void			userDefinedExternalTransition(Duration elapsedTime)
	{
		...
		this.lastReceived = (WindTurbineEventI) currentEvents.get(0);
