...
// -----------------------------------------------------------------------------
/**
 * The class <code>ChargeWATERTurbineerUnitTesterModel</code> defines a model that is used
 * to test the models defining the ChargeWATERTurbineer simulator.
 *
...
extends		AtomicModel
{
	...
	public static final String	URI = MiniHydroelectricDamUnitTesterModel.class.
															getSimpleName();
	...
	/**
	 * create a <code>ChargeWaterTurbineerUnitTesterModel</code> instance.
	 * 
	 ...
	 */
	public				MiniHydroelectricDamUnitTesterModel(
		String uri,
