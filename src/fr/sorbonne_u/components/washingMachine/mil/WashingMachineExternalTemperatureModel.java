 ...
 */
public class			WashingMachineExternalTemperatureModel
        extends		AtomicHIOA
{
    private static final long serialVersionUID = 1L;

	/** URI for a model; works when only one instance is created.			*/
    public static final String URI = WashingMachineExternalTemperatureModel.class.
            getSimpleName();
	 ...
	 */
    public WashingMachineExternalTemperatureModel(
            String uri,
