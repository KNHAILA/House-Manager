...
// -----------------------------------------------------------------------------
public class VacuumCleanerUserModel extends AtomicES_Model
{
    // -------------------------------------------------------------------------
     ...
     *  created.															*/
    public static final String			URI = fr.sorbonne_u.components.vacuumCleaner.mil.VacuumCleanerUserModel.class.
            getSimpleName();
    ...
    /**
     * create a VacuumCleaner user MIL model instance.
     *
    ...
    protected void		generateNextEvent()
    {
        ...
        if (current instanceof SwitchOnVacuumCleaner) {
            ...
            assert	current instanceof SwitchOffVacuumCleaner;
            nextEvent = new SwitchOnVacuumCleaner(t);
        }
