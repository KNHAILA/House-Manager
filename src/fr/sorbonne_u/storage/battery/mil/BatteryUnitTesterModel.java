...
// -----------------------------------------------------------------------------
/**
 * The class <code>ChargeBatteryerUnitTesterModel</code> defines a model that is used
 * to test the models defining the ChargeBatteryer simulator.
 *
 ...
 */
// -----------------------------------------------------------------------------
@ModelExternalEvents(exported = {UseBattery.class,
...
extends		AtomicModel
{
	...
	public static final String	URI = BatteryUnitTesterModel.class.
															getSimpleName();
	...
	/**
	 * create a <code>ChargeBatteryerUnitTesterModel</code> instance.
	 * 
	...
	public ArrayList<EventI>	output()
	{
		...
		if (this.step > 0 && this.step < 5) {
			...
			switch (this.step) {
			case 1:
				ret.add(new UseBattery(this.getTimeOfNextEvent()));
				break;
			case 2:
				ret.add(new ChargeBattery(this.getTimeOfNextEvent()));
				break;
			case 3:
				ret.add(new DoNotChargeBattery(this.getTimeOfNextEvent()));
				break;
			case 4:
				ret.add(new DoNotUseBattery(this.getTimeOfNextEvent()));
				break;
			}
			return ret;
		} else {
